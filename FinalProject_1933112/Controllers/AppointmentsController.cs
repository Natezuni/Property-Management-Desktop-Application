...
namespace FinalProject_1933112.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AppointmentID,TenantID,ManagerID,Appointment1")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppointmentID,TenantID,ManagerID,Appointment1")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
