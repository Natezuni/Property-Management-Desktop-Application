...
namespace FinalProject_1933112.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MessageID,TenantID,ManagerID,Message1")] Message message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MessageID,TenantID,ManagerID,Message1")] Message message)
        {
            if (ModelState.IsValid)
            {
